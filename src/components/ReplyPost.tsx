      ...
      <div className="w-full">
        ...
        {imagePreview && (
          <div className="h-60 md:h-100 rounded-lg overflow-hidden border border-border mb-10 relative">
            ...
            />
            <button
              className="absolute top-5 right-5 bg-gray-600 w-10 h-10 text-2xl rounded-full opacity-50 hover:opacity-100 cursor-pointer grid place-items-center"
              onClick={removeImage}
            >
              <RxCross2 size={20} />
            </button>
        ...
        <div className="flex justify-between items-center pt-2">
          <div className="flex gap-3">
            <div
              className="text-primary cursor-pointer hover:bg-hover p-2 rounded-full"
          ...
          {!isDisabled ? (
            <button className="text-black bg-white py-2 px-5 font-semibold cursor-pointer rounded-full hover:bg-gray-200">
              Post
            </button>
          ) : (
            <button
              disabled
              className="text-black bg-secondary-text/50 py-2 px-5 font-semibold cursor-not-allowed rounded-full"
            >
              Post
            </button>
          )}
